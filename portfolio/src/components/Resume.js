        ...
        <ul className="col s12 m4 icons">
          <li>
            <a href="https://docs.google.com/document/d/1UC0OCgNlM22cmg_NkxspxJTwd0IkPB8XkdoeQ3RjN5Q/edit?usp=sharing">
              <i className="tiny material-icons">list_alt</i> Official Resume
            </a>
          </li>
          <li>
            <a href="https://github.com/AMess33">
              <i className="tiny material-icons">email</i> GitHub
            </a>
          </li>
          <li>
            <a href="https://www.linkedin.com/in/amesser33/">
              <i className="tiny material-icons">place</i> Linked In
            </a>
          </li>
        </ul>
        <div className="container display-flex resumeContent">
          <div className="container display-flex experience">
            <h3>
              {" "}
              <i className="tiny material-icons">work</i> Professional
              Experience
            </h3>
            <div className="container display-flex jobs">
              <h4>
                EPC Inc.
          ...
          <div className="container display-flex education">
            <h4>
